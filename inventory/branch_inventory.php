                    ...
                    <div class='row mb-4'>
                        <div class='col-md-6'>
                            <div class='form-check'>
                                <input class='form-check-input' type='checkbox' id='editWithTBA'>
                                <label class='form-check-label' for='editWithTBA'>
                                    With TBA (Tools, Batteries and Accessories)
                                </label>
                            </div>
                        </div>
                        <div class='col-md-6'>
                            <div class='form-check'>
                                <input class='form-check-input' type='checkbox' id='editWithStockReport'>
                                <label class='form-check-label' for='editWithStockReport'>
                                    With Stock Report
                                </label>
                            </div>
                            <div class='stock-report-number-container mt-2' style='display: none;'>
                                <label for='editStockReportNumber' class='form-label'>Stock Report Number</label>
                                <input type='text' class='form-control' id='editStockReportNumber' 
                                       placeholder='Enter stock report number'>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class='col-md-4 border-end bg-light'>
                                <div class='p-4'>
                                    <fieldset>
                                        ...
                                        <div class='mb-3'>
                                            <label for='multipleTransferInvoiceNumber'
                                                class='form-label small fw-semibold'>
                                                <i class='bi bi-receipt me-1'></i>Transfer Invoice No. <span
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="redeemModalLabel">Redeem Motorcycle</h5>
            ...
            <div class="modal-body">
                <form id="redeemForm">
                    ...
                    <div class="alert alert-info small" role="alert">
                        You are redeeming a repossessed unit. Please re-enter the customer and sale details.
                    </div>
                    
                    <h6 class="text-primary">Redemption Details</h6>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="redeemDate" class="form-label">Redeem Date <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" id="redeemDate" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="redeemAmountPaid" class="form-label">Amount Paid <span class="text-danger">*</span></label>
                            <input type="number" step="0.01" class="form-control" id="redeemAmountPaid" placeholder="0.00" required>
                        </div>
                    </div>
                    
                    <hr>
                    <h6 class="text-primary">Original Sale Details</h6>
                    <div class="mb-3">
                        <label for="redeemSaleDate" class="form-label">Sale Date <span class="text-danger">*</span></label>
                        <input type="date" class="form-control" id="redeemSaleDate" required>
                    </div>

                    <div class="mb-3">
                        <label for="redeemCustomerName" class="form-label">Customer Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="redeemCustomerName" required>
                    </div>

                    <div class="mb-3">
                        <label for="redeemPaymentType" class="form-label">Payment Type <span class="text-danger">*</span></label>
                    ...
                    <div id="redeemCodFields" style="display: none;">
                        <div class="mb-3">
                            <label for="redeemDrNumber" class="form-label">DR Number <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="redeemDrNumber">
                        </div>
                        <div class="mb-3">
                            <label for="redeemCodAmount" class="form-label">COD Amount <span class="text-danger">*</span></label>
                    ...
                    <div id="redeemInstallmentFields" style="display: none;">
                        <div class="mb-3">
                            <label for="redeemTerms" class="form-label">Terms ( months ) <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="redeemTerms" min="1">
                        </div>
                        <div class="mb-3">
                            <label for="redeemMonthlyAmortization" class="form-label">Monthly Amortization <span class="text-danger">*</span></label>
                            <input type="number" step="0.01" class="form-control" id="redeemMonthlyAmortization">
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-success" id="submitRedeemBtn">Confirm Redemption</button>
            </div>
        </div>
    </div>
</div>
