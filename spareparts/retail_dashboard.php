<?php
session_start();
if (!isset($_SESSION['username']) || ($_SESSION['position'] !== 'Spareparts-Retail' && $_SESSION['position'] !== 'f')) {
...
<head>
    ...
    <title>Retail Dashboard - Spareparts MS</title>
    <meta name="description" content="SMDI Spare Parts Management - Retail Dashboard">
...
<body>
    ...
    <nav class="top-nav">
        <a class="nav-brand" href="#">
            ...
            <span class="nav-brand-text">Retail Dashboard</span>
        </a>
        <div class="nav-right">
            <!-- Notification Bell -->
    ...
    <div class="hero-banner">
        <div class="hero-content">
            ...
            <p class="hero-sub">
                ...
                <span class="hero-role-badge"><i class="bi bi-shop"></i> Retail</span>
            </p>
        </div>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-9">
                ...
                <div class="modules-grid">
                    ...
                    <a href="retail_sales_spareparts.php?tab=customers" class="module-card bg-menu-gray">
                        <div class="module-icon-wrap"><i class="bi bi-people"></i></div>
                        <div>
                            <div class="module-title">Customer</div>
                            <div class="module-desc">Manage local customer ledger</div>
                        </div>
                    ...
                    <a href="warehouse_spareparts.php" class="module-card bg-menu-red">
                        ...
                        <div>
                            ...
                            <div class="module-desc">View spareparts availability</div>
                        </div>
                        <div class="module-arrow">Open <i class="bi bi-arrow-right"></i></div>
                    </a>

                    <a href="retail_sales_spareparts.php?tab=sales" class="module-card bg-menu-purple">
                        <div class="module-icon-wrap"><i class="bi bi-receipt"></i></div>
                        <div>
                            <div class="module-title">Sales</div>
                            <div class="module-desc">Record Cash sales only</div>
                        </div>
                        <div class="module-arrow">Open <i class="bi bi-arrow-right"></i></div>
                    </a>

                    <a href="retail_sales_spareparts.php?tab=payments" class="module-card bg-menu-orange">
                    ...
                    <a href="retail_sales_spareparts.php?tab=returns" class="module-card bg-menu-teal">
                    ...
                    <a href="retail_sales_spareparts.php?tab=employees" class="module-card bg-menu-cyan">
                    ...
                    <a href="retail_sales_spareparts.php?tab=pricelists" class="module-card bg-menu-green">
                    ...
                    <a href="master_reports.php" class="module-card bg-menu-indigo">
                        ...
                        <div>
                            ...
                            <div class="module-desc">View retail sales & stock reports</div>
                        </div>
                        <div class="module-arrow">Open <i class="bi bi-arrow-right"></i></div>
                    </a>
