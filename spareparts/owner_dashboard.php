<?php
session_start();
if (!isset($_SESSION['username']) || $_SESSION['position'] !== 'Spareparts-Owner') {
...
<head>
    ...
    <title>Owner Dashboard - Spareparts MS</title>
    <meta name="description" content="SMDI Spare Parts Management - Owner Dashboard">
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .stat-card.bg-green { background: var(--green-800); border-color: var(--green-900); }
        .stat-card.bg-green .stat-label { color: rgba(255,255,255,0.7); }
        .stat-card.bg-green .stat-value { color: var(--white); }
        ...
        .summary-row-val { font-weight: 700; color: #d32f2f; }

        .sidebar-footer {
            background: #ffebee; border-top: 2.5px solid #ef5350;
            padding: 14px 20px;
        }
        .total-row {
...
<body>
    ...
    <nav class="top-nav">
        <a class="nav-brand" href="#">
            ...
            <span class="nav-brand-text">Owner Oversight</span>
        </a>
        <div class="nav-right">
            <div class="nav-user">
                ...
                <div>
                    ...
                    <div style="font-size:0.7rem;opacity:0.7;">System Owner</div>
                </div>
            </div>
    ...
    <div class="hero-banner">
        <div class="hero-content">
            ...
            <p class="hero-sub">
                ...
                &nbsp;|&nbsp; <i class="bi bi-shield-lock"></i> All Branches Access
                <span class="hero-role-badge"><i class="bi bi-person-badge"></i> Owner</span>
            </p>
        </div>
    </div>
                ...
                <div class="modules-grid">
                    ...
                    <a href="admin_spareparts.php?tab=dashboard" class="module-card bg-menu-blue">
                        ...
                        <div>
                            ...
                            <div class="module-desc">Consolidated branch statistics</div>
                        </div>
                    ...
                    <a href="admin_spareparts.php?tab=inventory" class="module-card bg-menu-orange">
                        ...
                        <div>
                            ...
                            <div class="module-desc">Manage stock across all branches</div>
                        </div>
                        <div class="module-arrow">Open <i class="bi bi-arrow-right"></i></div>
                    </a>
                    ...
                    <a href="admin_spareparts.php?tab=global-transfer" class="module-card bg-menu-blue">
                        ...
                        <div>
                            ...
                            <div class="module-desc">Monitor every stock movement</div>
                        </div>
                        <div class="module-arrow">Open <i class="bi bi-arrow-right"></i></div>
                    </a>
                    ...
                    <a href="admin_spareparts.php?tab=activity-log" class="module-card bg-menu-teal">
                        ...
                        <div>
                            ...
                            <div class="module-desc">Detailed activity & security logs</div>
                        </div>
                        <div class="module-arrow">Open <i class="bi bi-arrow-right"></i></div>
                    </a>
                    ...
                    <a href="master_reports.php" class="module-card bg-menu-green">
                        ...
                        <div>
                            ...
                            <div class="module-desc">Consolidated branch & financial reports</div>
                        </div>
                        <div class="module-arrow">Open <i class="bi bi-arrow-right"></i></div>
                    </a>
                    ...
                    <a href="find_stocks.php" class="module-card bg-menu-purple">
                        ...
                        <div>
                            ...
                            <div class="module-desc">Cross-branch stock locator</div>
                        </div>
                        <div class="module-arrow">Open <i class="bi bi-arrow-right"></i></div>
                    </a>
                    ...
                    <a href="user_management.php" class="module-card bg-menu-cyan">
                        ...
                        <div>
                            ...
                            <div class="module-desc">Manage system access & roles</div>
                        </div>
                        <div class="module-arrow">Open <i class="bi bi-arrow-right"></i></div>
                    </a>
