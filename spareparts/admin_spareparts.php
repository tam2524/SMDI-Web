            ...
            <nav class='navbar navbar-light bg-white navbar-expand-lg'>
                ...
                <div class='collapse navbar-collapse' id='navbarCollapse'>
                    <div class='navbar-nav'>
                        <a href='admin_spareparts.php' class='nav-item nav-link active'>Home</a>
    ...
    <main class='container-fluid py-5' style='margin-top: 110px;'>
        <div class='card shadow-sm mb-4'>
            <div class='card-header bg-white'>
                <h1 class='h5 mb-0'>Admin Spare Parts Inventory Management</h1>
            </div>
            <div class='card-body p-4'>
                <ul class='nav nav-tabs mb-4' id='mainTabs' role='tablist'>
                    <li class='nav-item' role='presentation'><button class='nav-link' id='activity-log-tab'
                            data-bs-toggle='tab' data-bs-target='#activityLog' type='button'><i
                                class="bi bi-clock-history me-2"></i>Activity Log</button></li>
                    ...
                    <li class='nav-item' role='presentation'><button class='nav-link' id='global-transfer-tab'
                            data-bs-toggle='tab' data-bs-target='#global-transfer' type='button'><i
                                class="bi bi-globe me-2"></i>Global Transfers History</button></li>
                </ul>
