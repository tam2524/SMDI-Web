                        ...
                        <div class='p-3 border rounded'>
                            <div class='row g-3'>
                                ...
                                <div class='col-md-6'>
                                  ...
                                  <div class='col-md-6' id='stockTbaFilterContainer'>
                                <label for='stockTbaFilter' class='form-label'>Stock Report/TBA</label>
                                <select class='form-select' id='stockTbaFilter'>
                                    <option value='all'>All Units</option>
                                    <option value='with_stock_report_only'>With Stock Report Only</option>
                                    <option value='with_tba_only'>With TBA Only</option>
                                    <option value='with_both'>With Both Stock Report & TBA</option>
                                </select>
                            </div>
                                <div class='col-12'>
...
<div class="modal fade" id="editShipmentModal" tabindex="-1" aria-labelledby="editShipmentModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 380px;">
    <div class="modal-content rounded-4">
      <div class="modal-header">
        <h5 class="modal-title fw-semibold" id="editShipmentModalLabel">Edit Direct Shipment</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <div class="modal-body">
        <!-- Hidden ID - This is now motorcycle_inventory.id -->
        <input type="hidden" id="editShipmentId">

        <!-- Shipment Date -->
        <div class="mb-3">
          <label for="editShipmentDate" class="form-label">Shipment Date <span class="text-danger">*</span></label>
          <input type="date" id="editShipmentDate" class="form-control" required>
        </div>

        <!-- Invoice Number -->
        <div class="mb-3">
          <label for="editShipmentInvoice" class="form-label">Invoice Number <span class="text-danger">*</span></label>
          <input type="text" id="editShipmentInvoice" class="form-control" placeholder="Enter invoice number" required>
        </div>
      </div>

      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-warning" data-bs-dismiss="modal">Cancel</button>
        <button type="button" id="saveEditShipmentBtn" class="btn btn-primary text-white">Save Changes</button>
      </div>
    </div>
  </div>
</div>
