                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <span class="me-2 text-muted small">Go to page:</span>
            ...
            <div class="tab-pane fade" id="users" role="tabpanel" aria-labelledby="users-tab">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column align-items-center">
                            <nav aria-label="Page navigation">
                                <ul id="usersPaginationControls" class="pagination mb-2">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <span class="me-2 text-muted small">Go to page:</span>
                                <input type="number" id="jumpToUsersPageInput" class="form-control form-control-sm me-2" style="width: 80px;" min="1">
                                <button id="jumpToUsersPageBtn" class="btn btn-sm btn-primary text-white">Go</button>
                            </div>
                        </div>
                    </div>
                </div>
